...
export const Route = createFileRoute("/_authenticated/definitions/")({
	...
	loader: ({ deps }) =>
		queryClient.ensureQueryData(definitionListQuery({ paginationState: deps.paginationState })),
				...
				{list?.length < 1 ? (
					<Empty className="mx-auto">
						<EmptyHeader>
							...
							<EmptyDescription>
								You haven&apos;t created any definitions yet. Get started by creating your first
								Definition.
							</EmptyDescription>
						</EmptyHeader>
					</Empty>
